...
<a href="login.php?redirect_to=/user.php?id=<?php echo $app->page->user['id']; ?>" class="friend"><?php if ($app->config->friends['asymmetric'] == TRUE) { echo 'Follow'; } else { echo 'Add friend'; } ?></a>
<?php } else {
