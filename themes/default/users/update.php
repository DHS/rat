...
<div class="row">
  <div class="span8 columns offset4">
    ...
    <ul class="tabs">
      <li<?php if ($this->page == 'profile') { echo ' class="active"'; } ?>><?php $this->link_to('Profile', 'settings', 'profile'); ?></li>
      <li<?php if ($this->page == 'password') { echo ' class="active"'; } ?>><?php $this->link_to('Password', 'settings', 'password'); ?></li>
    </ul>
