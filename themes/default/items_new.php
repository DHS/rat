...
<form action="item.php" method="post" enctype="multipart/form-data">
	...
	<table class="center">
		...
		if ($GLOBALS['app']['items']['uploads']['enabled'] == TRUE)
			echo '<tr><td class="align_right"><label for="upload">'.$GLOBALS['app']['items']['uploads']['name'].':</label></td><td class="alight_left"><input type="file" name="upload" id="upload" /></td></tr>';
		?>
